...
public partial class TodayIs: RuleSettingsControlBase<TodayIsConfig> {
    public TodayIs() {
        InitializeComponent();
    }
    ...
    void OnTargetTypeChanged() {
        Dispatcher.UIThread.Invoke((() => {
            DayOfWeekSelector.IsVisible = Settings.Target == TodayIsConfig.TargetType.DayOfWeek;
        }));
    }
    ...
    void TodayIs_OnLoaded(object? sender,RoutedEventArgs routedEventArgs) {
        OnTargetTypeChanged();
