...
public class ServicesFetcherService : IHostedService {
    public ServicesFetcherService(ILessonsService lessonsService, IExactTimeService exactTimeService, IProfileService profileService, ILogger<Plugin> logger, ILogger<ServicesFetcherService> selfLogger) {
